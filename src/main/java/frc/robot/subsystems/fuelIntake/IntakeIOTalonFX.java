...
public class IntakeIOTalonFX implements IntakeIO {
  ...
  private final LoggedTunableNumber rollerKg =
      new LoggedTunableNumber("Intake/Roller/kG", IntakeConstants.ROLLER_KG);
  ...
  // do we need cruise velocity for roller?
