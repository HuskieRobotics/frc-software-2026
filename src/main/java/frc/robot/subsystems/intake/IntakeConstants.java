...
public class IntakeConstants {
  ...
  public static final Angle DEPLOYED_ANGULAR_POSITION =
      Rotations.of(3.8244); // was 3.579 for 11.25 inches, now is 3.6605 for 11.5 inches
  ...
  public static final Voltage DEPLOYER_VOLTAGE = Volts.of(6.0);
  public static final double DEPLOYER_STALL_CURRENT = 20.0;
  public static final double DEPLOYER_STALL_TIME_THRESHOLD_SECONDS = 0.08;
