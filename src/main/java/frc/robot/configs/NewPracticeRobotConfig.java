...
public class NewPracticeRobotConfig extends RobotConfig {
  ...
  private static final Translation2d FRONT_RIGHT_CORNER_POSITION = new Translation2d(0.302940, -0.379140);
  ...
  private static final double COUPLE_RATIO = 3.857142857142857; // FIXME: update
  ...
  private static final Transform3d ROBOT_TO_BR_CAMERA =
      new Transform3d(
          new Translation3d(
              Units.inchesToMeters(-8.968),
              Units.inchesToMeters(-11.723),
              Units.inchesToMeters(-7.449)),
