...
// That code will stay here, commented out, while it is still possible that that motor makes a
// return.
...
public class HopperIOTalonFX implements HopperIO {
  ...
  private final LoggedTunableNumber rollerMotorKP =
      new LoggedTunableNumber("Hopper/ROLLER_KP", HopperConstants.ROLLER_KP);
  private final LoggedTunableNumber rollerMotorKI =
      new LoggedTunableNumber("Hopper/ROLLER_KI", HopperConstants.ROLLER_KI);
  private final LoggedTunableNumber rollerMotorKD =
      new LoggedTunableNumber("Hopper/ROLLER_KD", HopperConstants.ROLLER_KD);
  private final LoggedTunableNumber rollerMotorKV =
      new LoggedTunableNumber("Hopper/ROLLER_KV", HopperConstants.ROLLER_KV);
